    ...
    public static class CanUsePatch {
        ...
        public static SpireReturn<Boolean> CanUsePatchMethod(AbstractCard __instance, AbstractPlayer p, AbstractMonster m) {
            ...
            if (__instance.type == AbstractCard.CardType.STATUS
                    ...
                    && PowerUtils.GetPowerAmount(ToolForgeBPower.POWER_ID, AbstractDungeon.player) <= PrincipleUtils.GetPlayerPrincipleAmount(FORGE)
                    && PowerUtils.GetPowerAmount(ToolForgeBPower.POWER_ID, AbstractDungeon.player) != 0) {
