...
public class Health extends TemplateCustomCard {

    public static final String ID = StringUtils.MakeID(Health.class.getSimpleName());
    ...
    private static final String IMG_NAME = "health";
