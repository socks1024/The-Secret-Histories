...
public class ToolLanternFAction extends AbstractGameAction {
    ...
    public ToolLanternFAction(boolean upgrade) {
    ...
    public void update() {
        if (this.duration == Settings.ACTION_DUR_FAST) {
            ...
            if (this.p.exhaustPile.size() == 1) {
                if ((this.p.exhaustPile.group.get(0)).cardID.equals("Exhume") || (this.p.exhaustPile.group.get(0)).cardID.equals("TheSecretHistories:ToolLanternF")) {
                    this.isDone = true;
                    return;
                }
            ...
            for (Iterator<AbstractCard> c = this.p.exhaustPile.group.iterator(); c.hasNext(); ) {
                ...
                if (derp.cardID.equals("Exhume") || derp.cardID.equals("TheSecretHistories:ToolLanternF")) {
                    c.remove();
