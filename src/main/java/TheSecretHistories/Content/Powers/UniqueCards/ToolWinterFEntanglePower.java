...
public class ToolWinterFEntanglePower extends TemplateCustomPower {

    public static final String POWER_ID = StringUtils.MakeID(ToolWinterFEntanglePower.class.getSimpleName());

    private static final String IMG_NAME = "toolwinterf";

    public ToolWinterFEntanglePower(AbstractCreature owner) {
