...
public class SpiritGrailEEdgePower extends TemplateCustomPower {
    public static final String POWER_ID = StringUtils.MakeID(SpiritGrailEEdgePower.class.getSimpleName());
    private static final String IMG_NAME = "spirit_grailc_moth";

    private static final float REDUCTION_PER_STACK = 0.20f;

    public SpiritGrailEEdgePower(AbstractCreature owner, int amount) {
